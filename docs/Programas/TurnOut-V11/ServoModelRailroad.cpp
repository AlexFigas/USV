...
void ServoModelRailroad::show() {
  DebugMessagePrintf( 
    "{Index: %d, MinPos: %d, Pos: %d, MaxPos: %d, <Name: %s, Description: %s, MinPos: <%d, %d, %d>, MaxPos: <%d, %d, %d>>}\n", 
    this->_index, 
    this->_minPositionValue,
    this->_currentPositionValue,
    this->_maxPositionValue,
    this->_settings->servoName, this->_settings->servoDesc, this->_settings->minPosition.min, this->_settings->minPosition.value, this->_settings->minPosition.max, this->_settings->maxPosition.min, this->_settings->maxPosition.value, this->_settings->maxPosition.max );
}
