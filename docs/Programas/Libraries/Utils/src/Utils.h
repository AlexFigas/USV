...
#define serialBeginNoBlock( speed ) { Serial.begin( speed ); }
	...
	*/
	#define DebugMessagePrintf( ... ) { Serial.printf( __VA_ARGS__ ); }
	...
	*/
	#define DebugSerialBeginNoBlock( speed ) { serialBeginNoBlock( speed ); }
