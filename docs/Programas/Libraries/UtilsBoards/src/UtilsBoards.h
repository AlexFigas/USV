...
/*
	...
	Beasides the authentication credentials (name of the <b>SSID</b>, <b>identity/username</b> and <b>password</b>) this function accepts a set of aditional arguments that can be used to:
